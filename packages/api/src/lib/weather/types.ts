import type { WeatherData, RoadRisk, WeatherSource, ApiProvider } from "@driwet/db/schema/index";
...
export type Region = "south_america" | "north_america" | "europe" | "asia" | "oceania" | "africa";
