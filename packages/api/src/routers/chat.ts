...
import { safePlacesCache, type PlaceType } from '@advia/db/schema/index';
import { eq, and, gt } from 'drizzle-orm';

const SYSTEM_PROMPT = `Sos Advia, un asistente de clima y rutas para conductores en Argentina y Latinoamérica.
