...
export function SafetyStatusCard({
	...
	const displayMessage =
		message || t(config.defaultMessageKey, { time: "3 PM" });
	...
	return (
		<GestureDetector gesture={panGesture}>
			<Animated.View
				style={[styles.container, { backgroundColor }, containerAnimatedStyle]}
				accessible={true}
			...
			>
				...
				>
					...
					>
						<View
							style={[styles.divider, { backgroundColor: textColor + "20" }]}
						/>
				...
				<View style={styles.dragHandle}>
					<View
						style={[styles.handleBar, { backgroundColor: textColor + "30" }]}
					/>
				</View>
			</Animated.View>
		</GestureDetector>
