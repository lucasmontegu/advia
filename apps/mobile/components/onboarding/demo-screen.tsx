    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      >
        ...
        <View style={styles.routeLabel}>
          <Text style={[styles.routeLabelText, { color: colors.mutedForeground }]}>
        ...
        <View style={styles.routeContainer}>
          ...
          {showSafeStop && (
            <Animated.View style={[styles.safeStopPin, safeStopAnimatedStyle]}>
              <View style={[styles.safeStopMarker, { backgroundColor: themeColors.safety.safe.icon }]}>
                <Text style={styles.safeStopIcon}>⛽</Text>
              </View>
              <View style={[styles.safeStopLabel, { backgroundColor: colors.card }]}>
                <Text style={[styles.safeStopText, { color: colors.foreground }]}>
                  Safe Stop
                </Text>
              </View>
            </Animated.View>
      ...
      {showAIMessage && (
        ...
        >
          ...
          <View style={[styles.aiMessageBubble, { backgroundColor: colors.card }]}>
      ...
      >
        <View style={styles.featureRow}>
          <View style={[styles.featureBadge, { backgroundColor: themeColors.safety.safe.icon + '20' }]}>
