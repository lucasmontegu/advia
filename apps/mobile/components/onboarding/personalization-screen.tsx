...
const TRIP_OPTIONS: TripOption[] = [
	{
		id: "commute",
		icon: "clock",
		labelKey: "onboarding.personalization.options.commute",
	},
	{
		id: "roadTrips",
		icon: "route",
		labelKey: "onboarding.personalization.options.roadTrips",
	},
	{
		id: "business",
		icon: "location",
		labelKey: "onboarding.personalization.options.business",
	},
	{
		id: "longHaul",
		icon: "map",
		labelKey: "onboarding.personalization.options.longHaul",
	},
];
	...
	return (
		<View style={[styles.container, { backgroundColor: colors.background }]}>
			...
			>
				...
				>
					<Text
						style={[styles.selectionText, { color: colors.mutedForeground }]}
					>
						{selected.length === 0
